...
\begin{center}
{\bf\LARGE 60neV parxkaraNa.}\\
\vskip .3cm
{\rm COMPOUND INTEREST.}\\
\vskip .3cm
{\bf cakarxvALa baDiDxya leKaKxgaLanunx kuritadudx.}
\end{center}
...
\begin{verse}
kaM|| baDiDxya cakarxda leKaKxke| baDiDxya kANutatx loMdakada riMdasala|| nonxDaDxnu mADuta guNisuta | baDiDxya kUDutatx BAga gaDukaDe gANeY||

vi|| cakarx baDiDxya leKaKxdalilx heVLida darada meVrige $1$kekx eSuTx baDiDxyAgutetxMbuvadanunx tiLadu, adariMda asalanunx guNisi, baMda baDiDxyanunx asalige sheVrisutAtx punaH adariMda BAgi\-sutAtx eSuTx gaDuvina varige beVkoV aSaTxra varige mADa beVku. Adare idaralilx utatxravu savaRdhana shikukxtatxde. adaralilx asalanunx kaLadare niMtatxdeV baDiDxyAgirutatxde. matutx idanunx terxYrAshika parxkArakekx $1$ gaDuvina baDiDxyanunx kaMDu hiDadu adanunx asalige sheVrisikoMDu $2$neV gaDuvina asaleMdu BAvisi, adakekx punaH $2$neV gaDuvina baDiDxyanunx kaMDu hiDiDxyutAtx muMdU ideV parxkAra gaDugaLa pUreYsuva tanaka mADa bahudu. Adare idu sUthxla mAgaRvu.

udAharaNe, $100$ rUpAyige $1$ vaSaRkekx $5$ rUpAyi baDiDxya parxkArakekx $500$ rUpAyigaLige $3$ vaSaRkekx cakarx baDiDx eSATxguvadu?\\ 
\end{verse}
 
aMdare, 

\begin{tabular}{>{$}c<{$}>{$}c<{$}>{$}c<{$}}
100\;\text{rU.ge} & 1\; \text{rU. ge}\\[-8pt]
&& ::\; 5\; \text{rU. baDiDx.}\\[-8pt]
\quad 1\; \text{vaSaRkekx} & 1\; \text{vaSaRkekx}
\end{tabular}\\[5pt]

\qq \begin{tabular}{>{$}c<{$}>{$}c<{$}>{$}c<{$}}
\dfrac{1\times1}{1\times20}=\dfrac{1}{20}\quad \text{rUpAyi baDiDxyAyitu.}
\end{tabular}\\

adariMda asalanunx guNisa beVkAda pakaSxdalilx AMshavu oMdeV iruvadadxriMda adariMda guNisi $20$riMda BAgisuvadakokxVsakxra guNisuvadanunx biTuTx $20$riMda BAgisoVNaveV sAkAgirutatxde. hAyxgeMdare,\\
...
\qq\qq\quad\begin{tabular}{>{$}l<{$}>{$}l<{$}>{$}l<{$}>{$}l<{$}>{$}l<{$}>{$}l<{$}}
\text{rU.} & \text{A.} & \text{peY.}&&\\
\cline{6-6}
...
\item vaSaR oMdakekx sheVkaDeV $6$ rUpAyi meVrige $2$ vaSaRgaLalilx eSuTx rUpAyigaLa cakarx baDiDxyu $1545$ rUpAyigaLAdavu. \hfill \hbox{\text{utatxra}\; $12500$\; \text{rUpAyi.}}
\end{enumerate}
