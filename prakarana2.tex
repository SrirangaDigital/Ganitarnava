...
\begin{center}
\bf{\LARGE{2neV parxkaraNavu}}

\vskip .7cm

{\huge\bfseries kArayx parxkAshaka cinehxgaLanunx kuritadudx}
...
$\sqrt{\phantom{W}}$ \  $\sqrt[\text{3}]{\phantom{W}}$ ivu mUla cinehxgaLu. aMdare, avugaLa muMde baradaMthA aMkigaLanunx taleV meVle baradaMthA aMkigaLaSuTx mUlavanunx tegiyabeVkeMba athaRgaLanunx koDuvavu. Adare vagaR mUlavanunx tegiyuva cinehxyu meVlagxDe saMKayxvanunx bariya takakx saMparxdAyaviruvadilalxvu.\\
\begin{itemize}
...
\begin{center}
\bf{\large reVKA rUpavAda apUNaR BAgagaLu.}
\end{center}

$600${\rm l}$0$ kANi aMdare, pUNaR vasutxvina $\dfrac{1}{64}$ BAgavu.

\vskip .2cm

$6\div$ idu viVsavu, athavA pUNaR vasutxvina $\dfrac{1}{16}$ BAgavu.

\vskip .2cm

$6\RU$ idu beVLeyu, athavA pUNaR vasutxvina $\dfrac{1}{8}$ BAgavu.

\vskip .2cm

$6(\quad)$ idu mUruviVsavu, athavA pUNaR vasutxvina $\dfrac{3}{16}$ BAgavu.

\vskip .15cm

{\rm o1o} idu hAgavu, athavA pUNaR vasutxvina $\dfrac{1}{4}$ BAgavu. matutx kAlu,pAdaveMba hesaru.

\vskip .1cm

{\rm o\MU o} idu aDaDxvu, athavA aMdare, pUNaR vasutxvina $\dfrac{1}{2}$ BAgavAgiruvadu.

\vskip .1cm

{\rm o\SU o} idu mupApxgavu athavA mukAkxlf aMdare, pUNaR vasutxvina $\dfrac{3}{4}$ BAgavAgiruvadu.
\begin{center}
...
%\multicolumn{3}{|c|}{aDaDxvu.}\\
%\multicolumn{3}{|c|}{\MU}\\       

%\multicolumn{3}{|c|}{pAgavu.}\\
%\multicolumn{3}{|c|}{\SU}\\  
