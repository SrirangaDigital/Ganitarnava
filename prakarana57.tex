...
\item $4$ manuSayxru $3$ divasagaLalilx $96$ duDuDx kUliyanunx saMpAdisidare, adeV meVrige $5$ manuSayxru $12$ divasagaLalilx eSuTx kUliyanunx saMpAdishAyxru?

$
\left.
\begin{tabular}{>{$}c<{$}>{$}c<{$}>{$}c<{$}>{$}c<{$}>{$}c<{$}}
\text{manu}. && \text{manu}, && \text{duDuDx}\\
\quad4 & : & 5 & :: & 96\\
\text{di.} & : & \text{di.} 12\\
\end{tabular}
\right\}
$
\begin{tabular}{>{$}c<{$}}
5\times96=480\; \text{duDuDx}\\
\text{athavA $10$ rUpAyi.}
\end{tabular}

\item $5$ kuduregaLu $4$ divasagaLalilx $50$ sheVru huruLiyanunx tiMdare, adeV parxkArakekx $200$ sheVru huraLiyanunx $4$ kuduregaLu eSuTx divasagaLalilx tiMdAvu?

\begin{equation*}
\left.
\begin{tabular}{>{$}c<{$}>{$}c<{$}>{$}c<{$}}
4  & :\quad \quad5 \quad:: & 4\; \text{divasa}\\
50 & :\quad 200 \quad ::
\end{tabular}
\right \} 5\times4=20\; \text{divasa utatxravu.}
\end{equation*}
\end{enumerate}

\begin{center}
{\bf\large 76neV aBayx udAharaNe.}\\
\vskip .3cm
{sulaBavAda leKaKxgaLU.}
\end{center}
...
\item $2\dfrac{1}{2}$ maNa tupapxvu $8$ manuSayxrige $12$ divasakekx sAkAgutatxde. Adare, $16$ manuSayxrige $1$ vaSaRkekx eSuTx tupapx beVku?

\item goVdhige $27$ rUpAyi karxyaviruvAgeyx $18$ janaru $3$ divasagaLalilx $7\tfrac{1}{2}$ rUpAyigaLa roTiTxyanunx tinunxtAtxre. Adare goVdhi dhAraNe $25$ rUpAyi Ada kAladalilx $54$ janarige $27$ divasakekx eSuTx karxya bALuva roTiTxgaLu beVku?

\item $6$ janaru $10$ tAsugaLalilx $1\tfrac{1}{4}$ ekara BUmiya beLeyanunx koyuyxtAre. Adare, $9$ janaru $18$ tAsuga\-Lalilx eSuTx ekare peYranunx koyuyxtAtxre heVLu?

\item $10$ etutxgaLu $18$ ekare holavanunx $7$ divasagaLalilx utatxre, adeV parxkArakekx $171$ ekareya BUmiyanunx $35$ divasagaLalilx uLuvadakekx eSuTx  etutxgaLu beVku?
\end{enumerate}

\begin{center}
{\bf\large 77neV aBayx udAharaNe.}
\vskip .3cm
savxlapx kaThiNavAda leKaKxgaLU.
\end{center}
